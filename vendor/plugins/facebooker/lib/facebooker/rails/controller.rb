  ...
  module Rails
    module Controller
      ...
      def create_new_facebook_session_and_redirect!
        ...
        top_redirect_to session[:facebook_session].login_url({:next => next_url, :canvas => params[:fb_sig_in_canvas], :req_perms => 'status_update,offline_access'}) unless @installation_required
        false
      end
